...
class Auth_Controller extends CI_Controller {
	 ...
	 * Load dependencies
	 *
	 * If you're having trouble with sessions due to another library
	 * or package autoloading sessions, add the package path to your
	 * config/autoload, otherwise the session class modifications are
	 * not implemented, and you end up with a MySQL error because
	...
	protected function _set_user_variables()
	{
		...
		$this->auth_email    = $this->auth_data->email;
                $this->auth_locale    = $this->auth_data->locale;
                $this->auth_locale_id    = $this->auth_data->localization_id;
                $this->auth_language    = $this->auth_data->language;
		...
		$data = [
			...
			'auth_email'    => $this->auth_email,
                        'auth_locale'     => $this->auth_locale,
                        'auth_locale_id'     => $this->auth_locale_id,
                        'auth_language' => $this->auth_language
		];
		...
		$this->config->set_item( 'auth_email',    $this->auth_email );
                $this->config->set_item( 'auth_locale',     $this->auth_locale );
                $this->config->set_item( 'auth_locale_id',     $this->auth_locale_id );
                $this->config->set_item( 'auth_language', $this->auth_language );
