 ...
 */
function corporate_menu(){?>
    <h2 class="text-navy">Corporate menu</h2>
    <div class="hr-line-solid text-navy"></div>
    <ul class="list-group clear-list m-t">
        <li class="list-group-item fist-item">
            <a href="<?php echo base_url('admin/users/corporegister');?>"> 
            <span class="label label-success">RC</span> REGISTER COMPANY
            </a>
        </li>
        <li class="list-group-item fist-item">
            <a href="<?php echo base_url('admin/users/corporates');?>">
            <span class="label label-success">LC</span> LIST COMPANIES
            </a>
        </li>
    </ul>
<?php }
function users_menu(){?>
 <h2 class="text-navy">Users menu</h2>
    <div class="hr-line-solid text-navy"></div>
    <ul class="list-group clear-list m-t">
        <li class="list-group-item fist-item">
            <a href="<?php echo base_url('admin/users/corporates');?>"> 
            <span class="label label-success">RC</span> CORPORATE
            </a>
        </li>
        <li class="list-group-item fist-item">
            <a href="<?php echo base_url('admin/users/clients');?>">
            <span class="label label-success">LC</span> CLIENTS
            </a>
        </li>
    </ul>
<?php }
    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            <table class="table table-stripped small m-t-md">
                ...
                <tr>
                    <td class="no-borders">
                        <a class="text-navy text-uppercase" href="<?php echo base_url('admin/settings/profile');?>"><?php echo lang('menu_profilesettings');?></a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a class="text-navy text-uppercase" href="<?php echo base_url('admin/settings/app');?>"><?php echo lang('menu_systemsettings');?></a>
                    </td>
                </tr>
                </tbody>
            </table>
...
function profile_header(){
    $profile = config_item('profile_data');?>
    <div class="row m-b-lg m-t-lg">
                <div class="col-md-6">
                    <div class="profile-image">
                        <img src="<?php echo base_url('resources').'/img/'.$profile->avatar;?>" class="img-circle circle-border m-b-md" alt="avatar">
                    </div>
...
function users_cooporate_profiler(){
    $profile = config_item('profile_data');?>
    <div class="row m-b-lg m-t-lg">
                <div class="col-md-3">
                    <div class="profile-image">
