...
class Settings extends MY_Controller {
    ...
    public function index(){
        ...
        $this->data['cities'] = $this->system_model->weather_cities();
        $this->data['currency'] = $this->system_model->currencies();
        $this->load->vars($this->data);
        $this->load->view('expert/profile_settings');
    }
    
    public function profile(){
        if( $this->uri->uri_string() == 'expert/settings/profile'){
			show_404();
        }
        $this->data['localization'] = $this->system_model->localizations();
        $this->data['cities'] = $this->system_model->weather_cities();
    ...
    public function settingadd(){
        if( $this->uri->uri_string() == 'expert/settings/settingadd'){
			show_404();
        }
    ...
    public function appu(){
        if( $this->uri->uri_string() == 'expert/settings/appu'){
			show_404();
        }
        $this->data['localization'] = $this->system_model->localizations();
        $this->data['cities'] = $this->system_model->weather_cities();
        ...
        $this->load->vars($this->data);
        $this->load->view('expert/system_settings');
    }
    
    public function update(){
        if( $this->uri->uri_string() == 'expert/settings/update'){
			show_404();
        }
