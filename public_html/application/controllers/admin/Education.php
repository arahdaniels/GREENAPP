...
class Education extends MY_Controller {
  ...
  public function deletecategory() {
            if( $this->uri->uri_string() == 'admin/education/deletecategory')
			show_404();
    ...
    public function deletetypes() {
            if( $this->uri->uri_string() == 'admin/education/deletetypes')
			show_404();
     ...
     public function categorymodify($key = NULL) {
		...
		{   
           ...
           $this->load->view('admin/educategorymodify');
        }
    
        public function typemodify($key = NULL) {
         
            if( $this->uri->uri_string() == 'admin/education/typemodify')
			show_404();
		...
		{   
           ...
           $this->load->view('admin/edutypesmodify');
        }
     
        
    public function educategories($key = NULL) {
         
            if( $this->uri->uri_string() == 'admin/education/educategories')
			show_404();
             if( strtolower($this->input->server('REQUEST_METHOD')) == 'post'){ 
        ...
        $data['edu_localization']= $this->input->post('localization');
           ...
           $this->load->view('admin/educategories');
        }
    ...
    public function edutypes($key = NULL) {
        ...
        $data['type_localization']= $this->input->post('localization');
           ...
           $this->load->view('admin/edutypes');
        }
        
    public function search()
	{   
         if( $this->uri->uri_string() == 'admin/education/search')
			show_404();
           $this->load->view('admin/education_results');
	}
    
    public function videodetails($key=NULL)
	{   
         if( $this->uri->uri_string() == 'admin/education/videodetails')
			show_404();
          $edudata['video'] = $this->system_model->admin_edu_video($key); 
          $this->load->vars($edudata);
           $this->load->view('admin/education_vdetails'); 
	}
        
    public function eduvideos()
	{   
         if( $this->uri->uri_string() == 'admin/education/eduvideos'){
			show_404();
         }
           if( strtolower($this->input->server('REQUEST_METHOD')) == 'post'){ 
		...
		{                     
           ...
           $edudata['videos'] = $this->system_model->admin_edu_videos(); 
           $edudata['types'] = $this->system_model->edu_types(); 
           $edudata['categories'] = $this->system_model->edu_categories(); 
           $edudata['currencies'] = $this->system_model->currencies(); 
           $this->load->vars($edudata);
           $this->load->view('admin/eduvideos'); 
	}
        
    public function videomodify($key=NULL)
	{   
         if( $this->uri->uri_string() == 'admin/education/videomodify')
			show_404();
		...
		{                     
            ...
            $edudata['currencies'] = $this->system_model->currencies(); 
            $this->load->vars($edudata);
           $this->load->view('admin/eduvideosmodify'); 
	}
        
     public function deletevideo() {
            if( $this->uri->uri_string() == 'admin/education/deletevideo')
			show_404();
