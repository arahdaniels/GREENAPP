            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                     <div class="ibox">
                        ...
                        <div class="ibox-content">
                           <?php $attr = array('method'=>'post'); echo form_open(base_url('expert/education/modifycategory/'.$category->edu_category_key),$attr);?>
                                            ...
                                            $i =1;
                                                foreach ($categories as $key => $value) { ?> 
                                                     <tr>                                                         
                                                        ...
                                                        <td><a class="text-primary" href="<?php echo base_url('expert/education/modifycategory/'.$value['edu_category_key']);?>"><?php echo lang('menu_modify');?></a> </td>
                                                    </tr>
                                           <?php $i++;}
                                       } ?>
...
<script src="<?php echo $this->config->item('resources');?>js/plugins/jasny/jasny-bootstrap.min.js"></script>
    <script>
        ...
        function removecategory( key ){
                    $.ajax({
                        url: '<?php echo base_url('expert/education/removecategory');?>',
                        type: 'post',
                        data: {'key' : key},
