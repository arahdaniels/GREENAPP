           ...
           <div class="col-lg-4">
                ...
                <ul class="list-group clear-list m-t">
                    <li class="list-group-item fist-item"> 
                        <a class="text-info" href="<?php echo base_url('expert/education/mvideo/'.$video->edu_videos_key);?>"> <i class="fa fa-pencil"></i>  <?php echo lang('menu_modify');?></a> 
                    </li> 
        ...
        swal({
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                     $.ajax({
                        url: '<?php echo base_url('expert/education/removevideo');?>',
                        type: 'post',
                        data: {'key' : key},
                        success: function( result ){
                            resolve( result )
                            window.document.location.href = '<?php echo base_url('expert/education/videos');?>';
                        },
                        error: function(xhr){
