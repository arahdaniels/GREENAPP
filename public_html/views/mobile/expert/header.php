...
<body class="top-navigation" style="padding-top: 30px;">
 <div id="wrapper">
            ...
            <div class="navbar-collapse collapse" id="navbar">
                <ul class="nav navbar-nav" style="text-transform: uppercase; ">
                    ...
                    <li class="dropdown <?php if( ! empty($page) && $page == 'agriculture') echo 'active';?>" >
                        ...
                        <ul role="menu" class="dropdown-menu">
                            <li><a href="<?php echo base_url('expert/fertilizers');?>"><?php echo lang('menu_fertilizers');?></a></li>
                            <li><a href="<?php echo base_url('expert/crops');?>"><?php echo lang('menu_crops');?></a></li>
                            <li><a href="<?php echo base_url('expert/landtypes');?>"><?php echo lang('menu_landtypes');?></a></li>
                            <li><a href="<?php echo base_url('expert/landcrops');?>"><?php echo lang('menu_landcrops');?></a></li>
                        </ul>
                    </li>
                    
                    <li class="<?php if( ! empty($page) && $page == 'settings') echo 'active';?>"><a href="<?php echo base_url('expert/settings');?>"><?php echo lang('menu_settings');?></a></li>
                </ul>
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown <?php if( ! empty($page) && $page == 'profile') echo 'active';?>">
                        ...
                        <ul role="menu" class="dropdown-menu">
                           <!-- <li><a href="<?php echo base_url('expert/overview');?>"><?php echo lang('menu_overview');?></a></li>-->
                            <li><a href="<?php echo base_url('expert/settings');?>"><?php echo lang('menu_settings');?></a></li>
                            <li>
