           ...
           <div class="row  border-bottom bg-primary page-heading" style="margin-bottom: 30px;">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb bg-primary">
                        <li>
                            <a href="<?php echo base_url('admin/education');?>"><?php echo lang('menu_education');?></a>
                        </li>
                        <li class="active">
        ...
        <div class="row">
            <div class="col-lg-8">
                       <div class="ibox">
                        ...
                        <div class="ibox-content">
                           <?php $attr = array('method'=>'post','id'=>'add-edu-video'); echo form_open(base_url('admin/education/videos'),$attr);?>
                                               ...
                                               if($value['edu_videos_mode'] =='paid'){$class = 'label-warning';}else{$class = 'label-primary';};?>
                                                <tr>
                                                    ...
                                                    <td class="project-title">
                                                        <a href="<?php echo base_url('admin/educattion/videodetails');?>"><?php echo $value['edu_video'];?></a>
                                                    </td>
                                                     <td class="project-title">
                                                    ...
                                                    <td class="project-actions">
                                                        <a href="<?php echo base_url('admin/education/dvideo/'.$value['edu_videos_key']);?>"><?php echo lang('menu_details');?></a> | 
                                                        <a href="<?php echo base_url('admin/education/mvideo/'.$value['edu_videos_key']);?>"><?php echo lang('menu_modify');?></a> | 
        ...
        $(function(){  
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/admin/education/videos',
                        type: 'post',
                        data: data,
