            ...
            <div class="container">
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb bg-primary">
                        ...
                        <li>
                            <a href="<?php echo base_url('admin/settings');?>" style="text-transform: capitalize;"><?php echo lang('menu_settings');?></a>
                        </li>
                        <li class="active">
                            ...
                            <div class="tab-content ">
                                <div id="tab-localization" class="tab-pane active">
                                    <div class="panel-body">
                                       <?php $attr = array('class'=>'form-horizontals','method'=>'post','id'=>'localization'); 
                                            echo form_open(base_url('admin/settings/updatesystemsettings'),$attr);?>
                                ...
                                <div class="panel-body">
                                    <?php $attr = array('class'=>'form-horizontal','method'=>'post','id'=>'addsettings'); 
                                            echo form_open(base_url('admin/settings/addsystemsettings'),$attr);?>
        ...
        swal({
            ...
            preConfirm: ( name ) => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/admin/settings/addsystemsettings',
                        type: 'post',
    ...
    function deleteunit( key ){
     ...
     $('form#localization').submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'https://greenapp.co.tz/admin/settings/updatesystemsettings',
                        type: 'post',
                        data: data,
                        success: function( result ){
                                resolve( result );
     ...
     $('form#currency').submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/admin/settings/updatesystemsettings',
                        type: 'post',
                        data: data,
                        success: function( result ){
                                resolve( result );
