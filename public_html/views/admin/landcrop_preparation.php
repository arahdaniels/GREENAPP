                            ...
                            <div class="ibox-title bg-primary text-capitalize">
                                <h5 class="text-uppercase"><i class="fa fa-plus-square fa-1x"></i> <?php echo $landcrop->landtype.' - '.$landcrop->crop;?>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="optionsmenu">
                                          ...
                                          <li class="text-navy"><a href="<?php echo base_url('admin/landtypes/cultivation/'.$landcrop->landcrops_id);?>"><?php echo lang('menu_landcultivation');?></a></li>
                        ...
                        <div class="ibox-content">
                               <div class="row">
                                    <?php $attr = array('class'=>'form-horizontals','method'=>'post','id'=>'addstageform'); 
                                            echo form_open(base_url('admin/landprepare/addstage'),$attr);?>
                                            ...
                                            foreach ($landprepares as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 30%;" class="vertical-align">
                                                        ...
                                                        | <a class="text-navy" href="<?php echo base_url('admin/landtypes/stagedetails/'.$value['landprepare_landcrop'].'/'.$value['landprepare_id']);?>"><?php echo lang('menu_details');?></a></td>                                                     
                                                </tr>
                                          <?php }
                                        } ?>                                        
                                    </tbody> 
        ...
        swal({
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'https://greenapp.co.tz/admin/landprepare/deletelandprepare',
                        type: 'post',
                        data: {'key' : key },
     ...
     $(document).ready(function() {   
        ...
        form.submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'https://greenapp.co.tz/admin/landprepare/addstage',
                        type: 'post',
                        data: data,
                        success: function( result ){
                                resolve( result );
