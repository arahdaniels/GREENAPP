        ...
        <div class="wrapper wrapper-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                           <?php $attr = array('method'=>'post'); echo form_open(base_url('admin/education'),$attr);?>
                           ...
                           <?php $attr = array('method'=>'post'); echo form_open(base_url('admin/education'),$attr);?>
                            ...
                            <div class="form-group">
                               <!-- <label><?php echo lang('menu_type'); ?></label>-->
                                <input value="<?php echo lang('menu_type'); ?>" required name="edu_type" class="form-control" placeholder="<?php echo lang('menu_type'); ?>" />
                            </div>
                            <button class="btn btn-primary btn-block text-uppercase"><?php echo lang('menu_submit'); ?></button>
                        <?php echo form_close();?>
                        </div>
                ...
                <div class="col-lg-9">
                     <div class="ibox">
                        <div class="ibox-title bg-primary text-uppercase">                            
                            <h3><?php echo lang('menu_modifycategory'); ?></h3>
                        </div>
                        <div class="ibox-content">
                           <?php $attr = array('method'=>'post'); echo form_open(base_url('admin/education/modifycategory/'.$category->edu_category_key),$attr);?>
                            <input value="<?php echo $category->edu_category_key;?>" name="udi" type="hidden" readonly />
                            <input value="addcategory" name="types" type="hidden" readonly />
                            <div class="form-group">
                               <!-- <label><?php echo lang('menu_category'); ?></label>-->
                                <input value="<?php echo $category->edu_category;?>" required name="edu_category" class="form-control" placeholder="<?php echo lang('menu_category'); ?>" />
                            </div>
                            <button class="btn btn-primary btn-block text-uppercase"><?php echo lang('menu_submit'); ?></button>
                        <?php echo form_close();?>
                        </div>
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true"> <i class="fa fa-list"></i> <?php echo lang('menu_categories');?></a></li>
                             <li><a data-toggle="tab" href="#tab-2" aria-expanded="true"> <i class="fa fa-list-alt"></i> <?php echo lang('menu_types');?></a></li>
                        </ul>
                                            ...
                                            $i =1;
                                                foreach ($categories as $key => $value) { ?> 
                                                     <tr>                                                         
                                                        ...
                                                        <td><a class="text-primary" href="<?php echo base_url('admin/education/modifycategory/'.$value['edu_category_key']);?>"><?php echo lang('menu_modify');?></a> </td>
                                                    </tr>
                                           <?php $i++;}
                                       } ?>
                                            ...
                                            $i =1;
                                                foreach ($types as $key => $value) { ?> 
                                                     <tr>                                                         
                                                        ...
                                                        <td><a class="text-primary" href="<?php echo base_url('admin/education/modifytypes/'.$value['edu_types_key']);?>"><?php echo lang('menu_modify');?></a> | 
...
<script src="<?php echo $this->config->item('resources');?>js/plugins/jasny/jasny-bootstrap.min.js"></script>
    <script>
        ...
        function removecategory( key ){
                    $.ajax({
                        url: '<?php echo base_url('admin/education/removecategory');?>',
                        type: 'post',
                        data: {'key' : key},
