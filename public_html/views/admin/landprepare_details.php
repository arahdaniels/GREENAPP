<?php include('header.php');?>
        <div class="wrapper wrapper-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <h3 class="text-navy text-uppercase"><a class="text-navy" href="<?php echo base_url('admin/landtypes/preparation/'.$key2);?>"><?php echo $landcrop->landtype.' - '.$landcrop->crop;?></a></h3>
        ...
        form.submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'https://greenapp.co.tz/admin/landprepare/updatestage',
                        type: 'post',
                        data: data,
