<?php include('header.php');
    // create curl resource 
        ...
        // set url 
    //    curl_setopt($ch, CURLOPT_URL, "https://dataservice.accuweather.com/forecasts/v1/daily/1day/".$weather->city_serial."?apikey=Q1x2n9bLPg0YnGTantWVj1SK3K2IGZa9&metric=true"); 
    ...
    <link href="<?php echo $this->config->item('resources');?>css/plugins/footable/footable.core.css" rel="stylesheet">
        ...
        <div class="wrapper wrapper-content">
            <div class="container">
                ...
                <div class="col-lg-10">
                    <h2><?php echo lang('menu_overview');?></h2>
                    <ol class="breadcrumb bg-primary">
                        <li>
                            <a href="<?php echo base_url('client/dashboard');?>"><?php echo lang('menu_dashboard');?></a>
                        </li>
                        <li>
                            <a style="text-transform: capitalize;"><?php echo lang('menu_profile');?></a>
                        </li>
                        <li class="active">
      ...
      "Link": "https://www.accuweather.com/en/tz/dar-es-salaam/317663/daily-weather-forecast/317663?day=1&unit=c&lang=en-us"
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                           <?php $attr = array('method'=>'post'); echo form_open(base_url('admin/weather/cities'),$attr);?>
                ...
                <div class="col-lg-9">
                    <div class="ibox">
                        <div class="ibox-title bg-primary text-uppercase">                            
                            <h3><?php echo lang('menu_modifycity').' - '.$city->city_name ?></h3>
                        </div>
                        <div class="ibox-content">
                           <?php $attr = array('method'=>'post'); echo form_open(base_url('admin/weather/modifycity/'.$city->city_serial),$attr);?>
                            <input value="<?php echo $city->city_id;?>" name="types" type="hidden" readonly />
                            <div class="form-group">
                                <select class="form-control" name="city_locale">
                                    <?php if(! empty($localization)){
                                        foreach ($localization as $key => $value) {  ?>
                                        <option <?php if($value['localization_id'] == $city->city_locale){ echo 'selected';}?> class="text-capitalize"  value="<?php echo $value['localization_id'];?>"><?php echo ucfirst($value['locale']);?></option>
                                    <?php } }else{?>
                                        <option value="">Country not available</option>
                                    <?php } ?>
                                 </select>
                            ...
                            <div class="form-group">
                               <!-- <label><?php echo lang('menu_cityname'); ?></label>-->
                                <input value="<?php echo $city->city_name;?>" required name="city_name" class="form-control" placeholder="<?php echo lang('menu_cityname'); ?>" />
                            </div>
                            <div class="form-group">
                               <!-- <label><?php echo lang('menu_citycode'); ?></label> -->
                                <input value="<?php echo $city->city_code;?>" required name="city_code" class="form-control" placeholder="<?php echo lang('menu_citycode'); ?>" />
                            </div>
                            <div class="form-group">
                                <!--<label><?php echo lang('menu_cityserial'); ?></label>-->
                                <input value="<?php echo $city->city_serial;?>" required name="city_serial" class="form-control" placeholder="<?php echo lang('menu_cityserial'); ?>" />
                            </div>
                            <button class="btn btn-primary btn-block text-uppercase"><?php echo lang('menu_submit'); ?></button>
                        <?php echo form_close();?>
                        </div>
                                            ...
                                            $i =1;
                                                foreach ($cities as $key => $value) { ?> 
                                                     <tr>                                                         
                                                        ...
                                                        <td><a class="text-primary" href="<?php echo base_url('admin/weather/modifycity/'.$value['city_serial']);?>"><?php echo lang('menu_modify');?></a></td>
                                                    </tr>
                                           <?php $i++;}
                                       } ?>
...
<!-- FooTable -->
    ...
    <script>
        ...
        function removecity( key ){
                    $.ajax({
                        url: '<?php echo base_url('admin/weather/removecity');?>',
                        type: 'post',
                        data: {'key' : key},
