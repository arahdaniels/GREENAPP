                    ...
                    <div class="ibox-title bg-primary">
                        ...
                        <div class="ibox-content">
                                    <?php $attr = array('class'=>'form-horizontal','method'=>'post','id'=>'addlandcrop'); 
                                            echo form_open(base_url('admin/landtypes/addlandcrop'),$attr);?>
    ...
    function deletelandcrop( key ){
        swal({
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'https://greenapp.co.tz/admin/landtypes/deletelandcrop',
                        type: 'post',
     ...
     $(document).ready(function() {    
        ...
        form.submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'https://greenapp.co.tz/admin/landtypes/addlandcrop',
                        type: 'post',
                        data: data,
                        success: function( result ){
                                resolve( result );
