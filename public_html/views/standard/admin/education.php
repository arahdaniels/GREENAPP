                ...
                <div class="col-lg-3">
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                           <?php $attr = array('method'=>'post','id'=>'addcategory'); echo form_open(base_url('admin/education'),$attr);?>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                           <?php $attr = array('method'=>'post','id'=>'addtypes'); echo form_open(base_url('admin/education'),$attr);?>
                                            ...
                                            $i =1;
                                                foreach ($categories as $key => $value) { ?> 
                                                     <tr>                                                         
                                                        ...
                                                        <td><a class="text-primary" href="<?php echo base_url('admin/education/modifycategory/'.$value['edu_category_key']);?>"><?php echo lang('menu_modify');?></a> | 
        ...
        $('form#addcategory').submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/admin/education',
                        type: 'post',
                        data: data,
