        ...
        swal({
            ...
            preConfirm: ( fertilizer ) => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/admin/fertilizers/modifyfertilizer',
                        type: 'post',
    ...
    function deletefertilizer( key ){
        swal({
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/admin/fertilizers/deletefertilizer',
                        type: 'post',
     ...
     $(document).ready(function() {    
        ...
        form.submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/admin/fertilizers/addfertilizer',
                        type: 'post',
                        data: data,
                        success: function( result ){
                                resolve( result );
