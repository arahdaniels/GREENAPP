                            ...
                            <div id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                  <input type="text" class="form-control input-sm m-b-xs" id="filter" placeholder="Search in table">
                                    <table class="table footables table-stripped" data-page-size="10" data-filter=#filter>
                                        <thead>
                                        <tr>
                                            <th>#</th>
                                            ...
                                            $i =1;
                                                foreach ($cities as $key => $value) { ?> 
                                                     <tr>                                                         
                                                        ...
                                                        <td><a class="text-primary" href="<?php echo base_url('admin/weather/locations/'.$value['city_serial']);?>"><?php echo lang('menu_locations');?></a> | <a class="text-primary" href="<?php echo base_url('admin/weather/modifycity/'.$value['city_serial']);?>"><?php echo lang('menu_modify');?></a> | 
