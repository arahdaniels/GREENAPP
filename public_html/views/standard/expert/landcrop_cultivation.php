                            ...
                            <div class="ibox-title bg-primary text-capitalize">
                                <h5 class="text-uppercase"><i class="fa fa-plus-square fa-1x"></i> <?php echo $landcrop->landtype.' - '.$landcrop->crop;?>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="optionsmenu">
                                          ...
                                          <li class="text-navy"><a href="<?php echo base_url('expert/landtypes/preparation/'.$landcrop->landcrops_id);?>"><?php echo lang('menu_landpreparation');?></a></li>
                        ...
                        <div class="ibox-content">
                               <div class="row">
                                    <?php $attr = array('class'=>'form-horizontals','method'=>'post','id'=>'addcultivationstage'); 
                                            echo form_open(base_url('expert/landtypes/addcultivationstage'),$attr);?>
                                            ...
                                            foreach ($cultivations as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 30%;" class="vertical-align">
                                                        ...
                                                        | <a class="text-navy" href="<?php echo base_url('expert/landtypes/cdetails/'.$value['landcultivation_landcrop'].'/'.$value['landcultivation_id']);?>"><?php echo lang('menu_details');?></a></td>                                                     
                                                </tr>
                                          <?php }
                                        } ?>                                        
                                    </tbody> 
        ...
        swal({
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/landtypes/deletecultivation',
                        type: 'post',
                        data: {'key' : key },
     ...
     $(document).ready(function() {   
        ...
        form.submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/landtypes/addcultivationstage',
                        type: 'post',
                        data: data,
                        success: function( result ){
                                resolve( result );
