                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                                    <?php $attr = array('class'=>'form-horizontal','method'=>'post','id'=>'addcrop'); 
                                            echo form_open(base_url('expert/crops/addcrop'),$attr);?>
        ...
        swal({
            ...
            preConfirm: ( crop ) => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/crops/modifycrop',
                        type: 'post',
    ...
    function deletecrop( key ){
        swal({
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/crops/deletecrop',
                        type: 'post',
                        data: {'crop_id' : key },
                        success: function( result ){
                                resolve( result );
     ...
     $(document).ready(function() {    
        ...
        form.submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/crops/addcrop',
                        type: 'post',
                        data: data,
                        success: function( result ){
                                resolve( result );
