            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="ibox-title bg-primary">
                        <h5 class="text-uppercase"><?php echo lang('menu_landmanagement').' | '. lang('menu_create');?></h5>
                    </div>
                        <div class="ibox-content">
                                    <?php $attr = array('class'=>'form-horizontal','method'=>'post','id'=>'addlandcrop'); 
                                            echo form_open(base_url('expert/landtypes/addlandcrop'),$attr);?>
                                    ...
                                    <tbody >
                                        <tr >
                                         ...
                                         <tr >
                                            ...
                                            <td class="vertical-align">
                                                ...
                                                <?php if(!empty($crops)){
                                                    ...
                                                    <option value="<?php echo $value['crop_id'];?>"><?php echo $value['crop'];?></option>
                                                   <?php }
                                                } ?>
                                                </select>
                                            </td>
                                         ...
                                         <tr >
                                            ...
                                            <td class="vertical-align">
                                                <input required type="number" name="preparation_stages" placeholder="<?php echo lang('menu_preparationstages');?>" class="form-control" />
                                            </td>
                                        </tr>
                                        <tr >
                                            <td class="vertical-align"><b><?php echo lang('menu_cultivationstages');?></b></td>
                                            <td class="vertical-align">
                                                <input required  type="number" name="cultivation_stages" placeholder="<?php echo lang('menu_cultivationstages');?>" class="form-control" />
                                            </td>
                                        </tr>
                                        <tr>
                                              <td></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="optionsmenu">
                                                          ...
                                                          <li><a href="<?php echo base_url('expert/landtypes/modify/'.$value['landcrops_id']);?>"><?php echo lang('menu_modify');?></a></li>
                                                          <li><a href="<?php echo base_url('expert/landtypes/preparation/'.$value['landcrops_id']);?>"><?php echo lang('menu_landpreparation');?></a></li>
                                                          <li><a href="<?php echo base_url('expert/landtypes/cultivation/'.$value['landcrops_id']);?>"><?php echo lang('menu_landcultivation');?></a></li>
                                                          <li><a href="<?php echo base_url('expert/landtypes/applyfert/'.$value['landcrops_id']);?>"><?php echo lang('menu_fertilizerapplication');?></a></li>
                                                        </ul>
                                                      </div></td> 
        ...
        swal({
            ...
            preConfirm: ( landtype ) => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/landtypes/addlandtype',
                        type: 'post',
    ...
    function deletelandcrop( key ){
        swal({
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/landtypes/deletelandcrop',
                        type: 'post',
     ...
     $(document).ready(function() {    
         $('form#addlandcrop').each( function(){
        var form = $( this );
        form.submit( function(e){
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/landtypes/addlandcrop',
                        type: 'post',
                        data: data,
                        success: function( result ){
                                resolve( result );
