                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                                    <?php $attr = array('class'=>'form-horizontal','method'=>'post','id'=>'addlandtype'); 
                                            echo form_open(base_url('expert/landtypes/addlandtype'),$attr);?>
        ...
        swal({
            ...
            preConfirm: ( landtype ) => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/landtypes/modifylandtype',
                        type: 'post',
    ...
    function deletelandtype( key ){
        swal({
            ...
            preConfirm: () => {
              return new Promise((resolve) => {
                  $.ajax({
                        url: 'http://greenapp.co.tz/expert/landtypes/deletelandtype',
                        type: 'post',
