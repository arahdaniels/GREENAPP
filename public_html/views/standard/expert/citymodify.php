      ...
      "Link": "http://www.accuweather.com/en/tz/dar-es-salaam/317663/daily-weather-forecast/317663?day=1&unit=c&lang=en-us"
                ...
                <div class="col-lg-9">
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                           <?php $attr = array('method'=>'post'); echo form_open(base_url('expert/weather/modifycity/'.$city->city_serial),$attr);?>
                                            ...
                                            $i =1;
                                                foreach ($cities as $key => $value) { ?> 
                                                     <tr>                                                         
                                                        ...
                                                        <td><a class="text-primary" href="<?php echo base_url('expert/weather/modifycity/'.$value['city_serial']);?>"><?php echo lang('menu_modify');?></a></td>
                                                    </tr>
                                           <?php $i++;}
                                       } ?>
